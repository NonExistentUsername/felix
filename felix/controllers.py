...
class TelegramPetsMainController(IController):
    def __init__(self) -> None:
        ...
        self.__engine_background_thread = threading.Thread(target=self.__engine.run, daemon=True)
        self.__telegram_controller = TelegramController(self.__engine.get_di_container())
